...
-- function to count the number of files that will be created by the tool
numberOfElements = 3
function elementCount(name, XSDElement)
...
function elementParser(name, XSDElement) 
   ...
   local fmt = {
      '/* command to split output: csplit - \'/\/\* FILE: /\' {'..numberOfElements..'} */\n',
      '/* FILE: %s.java */\n',
